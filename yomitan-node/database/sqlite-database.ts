...
const requirePackage = typeof import.meta.url === 'string' ? createRequire(import.meta.url) : require;
const {pushSQLiteSchema} = requirePackage('drizzle-kit/api') as typeof DrizzleKit;
